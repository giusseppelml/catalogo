...
#BORRAR CATEGORIA
    ...
    {
        $stmt = Conexion::conectar()->prepare("INSERT INTO $tabla (titulo, descripcion, contenido, imagen, precio, calificacion, categoria) VALUES (:titulo, :descripcion, :contenido, :imagen, :precio, :calificacion, :categoria)");
        ...
        $stmt->bindParam(":calificacion", $datosModel["calificacion"], PDO::PARAM_INT);
    ...
    public function updateProductoModel($datosModel, $tabla)
    {
        ...
        $stmt = Conexion::conectar()->prepare("UPDATE $tabla SET titulo = :titulo, descripcion = :descripcion, contenido = :contenido, imagen = :imagen, precio = :precio, calificacion = :calificacion, categoria = :categoria WHERE id = :id");
